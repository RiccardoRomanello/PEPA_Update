...
public class CSLNextNode extends CSLAbstractPathProperty {
	...
	public CSLAbstractPathProperty copy() {
		return new CSLNextNode(property.copy(), timeBound.copy());
	}
	...
	public int hashCode() {
		return property.hashCode() + timeBound.hashCode() + 14;
	}
	...
	public CSLAbstractPathProperty normalise() {
		...
		return new CSLNextNode(normal, timeBound);
	}
