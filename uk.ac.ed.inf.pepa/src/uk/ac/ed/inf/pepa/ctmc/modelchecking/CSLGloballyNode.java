...
public class CSLGloballyNode extends CSLAbstractPathProperty {

	private CSLAbstractStateProperty property;
	private CSLTimeInterval timeBound;
	
	public CSLGloballyNode(CSLAbstractStateProperty property, CSLTimeInterval timeBound) {
	...
	public CSLAbstractPathProperty copy() {
		return new CSLGloballyNode(property.copy(), timeBound.copy());
	}
	...
	public boolean equals(Object o) {
		if (o instanceof CSLGloballyNode) {
			CSLGloballyNode node = (CSLGloballyNode)o;
	...
	public int hashCode() {
		return property.hashCode() + timeBound.hashCode() + 16;
	}
	...
	public CSLAbstractPathProperty normalise() {
		...
		return new CSLGloballyNode(normal, timeBound);
	}
