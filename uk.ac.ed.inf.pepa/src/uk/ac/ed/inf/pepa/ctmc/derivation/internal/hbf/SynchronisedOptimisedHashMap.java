...
public class SynchronisedOptimisedHashMap

{
	 ...
	 *             nonpositive
	 */
	public SynchronisedOptimisedHashMap(int initialCapacity, float loadFactor) {
	 ...
	 */
	public SynchronisedOptimisedHashMap(int initialCapacity) {
	 ...
	 */
	public SynchronisedOptimisedHashMap() {
	...
	public synchronized State getKey(State key) {
		if (key == null)
	...
	/**
	 * 
	 * @param key the state vector to find
	 * @param hashCode the already calculated hash code
	 * @return
	 */
	public synchronized State getKey(short[] key, int hashCode) {
		if (key == null)
			throw new NullPointerException();
	 ...
	 */
	public synchronized Object put(State key) {
		if (key == null)
