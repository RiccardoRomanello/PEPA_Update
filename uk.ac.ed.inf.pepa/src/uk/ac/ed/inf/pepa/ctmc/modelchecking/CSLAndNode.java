...
public class CSLAndNode extends CSLAbstractStateProperty {
	...
	public CSLAndNode(CSLAbstractStateProperty property1, CSLAbstractStateProperty property2) {
	...
	public CSLAbstractStateProperty copy() {
		return new CSLAndNode(property1.copy(), property2.copy());
	}
	...
	public StringPosition[] getChildren() {
		...
		int start2 = end1 + 3 + (property1.isSimple() ? 0 : 1)
	...
	public boolean equals(Object o) {
		if (o instanceof CSLAndNode) {
			CSLAndNode node = (CSLAndNode)o;
	...
	public CSLAbstractStateProperty normalise() {
		...
		return new CSLAndNode(normal1, normal2);
	}
