...
/**
 * This is the item provider adapter for a {@link uk.ac.ed.inf.pepa.emf.Aggregation} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AggregationItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Aggregation_process_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Aggregation_process_feature", "_UI_Aggregation_type"),
				 EmfPackage.Literals.AGGREGATION__PROCESS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addCopiesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Aggregation_copies_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Aggregation_copies_feature", "_UI_Aggregation_type"),
				 EmfPackage.Literals.AGGREGATION__COPIES,
				 true,
				 false,
				 false,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EmfPackage.Literals.AGGREGATION__PROCESS);
		}
