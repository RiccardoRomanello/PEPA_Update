...
/**
 * This is the item provider adapter for a {@link uk.ac.ed.inf.pepa.emf.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ActivityItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_rate_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_rate_feature", "_UI_Activity_type"),
				 EmfPackage.Literals.ACTIVITY__RATE,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EmfPackage.Literals.ACTIVITY__ACTION,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EmfPackage.Literals.ACTIVITY__RATE);
			childrenFeatures.add(EmfPackage.Literals.ACTIVITY__ACTION);
		}
