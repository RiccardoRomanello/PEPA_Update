...
public class SimulatorParameters
{
    ...
    private Double mConfidenceInterval;
    ...
    public String toString()
    {
        ...
        sb.append("confidenceInterval: " + mConfidenceInterval + "\n");
    ...
    /**
     * Set the confidence interval -alpha- with the given value
     * 
     * @param pConfidenceInterval the confidence interval
     */
    public void setConfidenceInterval(double pConfidenceInterval)
    {
    	mConfidenceInterval = new Double(pConfidenceInterval);
    }
    ...
    public void setConfidenceInterval(Double pConfidenceInterval)
    {
    	mConfidenceInterval = pConfidenceInterval;
    }
    
    /**
     * Return the confidence interval -alpha-
     * 
