...
public class BFCAPActionDelegate extends BasicProcessAlgebraModelActionDelegate
	...
	public void run(IAction action) {
		ActionCommands.capacityPlanning((IPepaModel) model,Config.SEARCHBRUTE, Config.EVALUTIL);
	}
