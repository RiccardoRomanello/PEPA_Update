...
public class DrivenCapacityPlanningCAPActionDelegate extends BasicProcessAlgebraModelActionDelegate
	...
	public void run(IAction action) {
		ActionCommands.capacityPlanning((IPepaModel) model,Config.SEARCHDRIVEN, Config.EVALUTIL);
	}
