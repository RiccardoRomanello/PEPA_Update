...
public class CapacityPlanningCAPActionDelegate extends BasicProcessAlgebraModelActionDelegate
	...
	public void run(IAction action) {
		ActionCommands.capacityPlanning((IPepaModel) model,Config.SEARCHSINGLE, Config.EVALUTIL);
	}
